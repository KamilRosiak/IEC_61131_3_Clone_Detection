 ...
 */
public class FBRS extends FBRawButton {

	private static final String[] INPUTPARAMETER = {"EN", "SET", "RESET1"};
	private static final String[] OUTPUTPARAMETER = {"Q1"};
	private static final String ID = "RS";
	
	/**
	 * creates an FBRS element from the FB language
	 * @param scale - to make the object bigger or smaller, default is 1
	 * @param colorValue 
	 */
	public FBRS(int scale, String Name, String[] inputExp, String[] outputExp, int colorValue) {
		super(ID, INPUTPARAMETER, OUTPUTPARAMETER, scale, Name, inputExp, outputExp, colorValue);
	}
	
	public FBRS(String Name, String[] inputExp, String[] outputExp, int colorValue) {

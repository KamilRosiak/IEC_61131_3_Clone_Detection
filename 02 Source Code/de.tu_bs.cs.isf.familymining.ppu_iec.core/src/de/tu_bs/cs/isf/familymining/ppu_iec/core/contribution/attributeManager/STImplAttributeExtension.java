...
public class STImplAttributeExtension implements IAttributeExtension {

	@Override
	public String getAttributeTypeName() {
		return PPUStringTable.ST_IMPLEMENTATION_ATTR_TYPE;
	}
	...
	public List<AbstractAttribute> getAttributes() {
		List<Object> attrs = RCPContentProvider.getInstanceFromBundle(PPUStringTable.ST_IMPL_ATTRIBUTE_SYMBOLIC_NAME ,PPUStringTable.ST_ATTR_EXTENSION);
	...
	public void execute(ServiceContainer services, AbstractAttribute attribute) {
		...
		services.eventBroker.send(PPUEventTable.ADD_ST_IMPL_ATTR, attribute);
	}

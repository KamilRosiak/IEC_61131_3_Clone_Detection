...
public class EmptyVarsAttr extends  AbstractPOUAttribute {
	/**
	 * 
	 */
	private static final long serialVersionUID = 119095714130805799L;
	public static final String ATTRIBUTE_NAME = "Empty Variable Attribute";
	public static final String ATTRIBUTE_DESCRIPTION = "If POU has no variables.";
	
	public EmptyVarsAttr() {

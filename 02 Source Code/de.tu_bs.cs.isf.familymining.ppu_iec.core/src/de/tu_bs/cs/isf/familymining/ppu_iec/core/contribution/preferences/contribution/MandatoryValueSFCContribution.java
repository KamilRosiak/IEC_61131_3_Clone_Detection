...
public class MandatoryValueSFCContribution {
	public static final String MANDATORY_VALUE_PREF = "MANDATORY_VALUE_SFCIMPL";
	public static final String SAVE_AS_RESULT_DESCRIPTION = "Mandatory Value SFC Impl";
	private KeyValueNode mandatoryValue;
	private LabeledSliderGroup labeledSliderGroup;
	
	public MandatoryValueSFCContribution(Composite parent) {

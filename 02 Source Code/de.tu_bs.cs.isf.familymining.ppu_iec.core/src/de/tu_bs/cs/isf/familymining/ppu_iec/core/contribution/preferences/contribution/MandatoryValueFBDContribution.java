...
public class MandatoryValueFBDContribution {
	public static final String MANDATORY_VALUE_PREF = "MANDATORY_VALUE_FBDIMPL";
	public static final String SAVE_AS_RESULT_DESCRIPTION = "Mandatory Value FBD Impl";
	private KeyValueNode mandatoryValue;
	private LabeledSliderGroup labeledSliderGroup;
	
	public MandatoryValueFBDContribution(Composite parent) {

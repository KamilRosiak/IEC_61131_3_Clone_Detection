...
public class EmptyImplAttr extends  AbstractPOUAttribute {
	/**
	 * 
	 */
	private static final long serialVersionUID = 119095714130805799L;
	public static final String ATTRIBUTE_NAME = "Empty POU implementation Attribute";
	public static final String ATTRIBUTE_DESCRIPTION = "If model has no POUs.";
	
	public EmptyImplAttr() {

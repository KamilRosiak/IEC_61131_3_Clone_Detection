...
public class FBDImplAttributeExtension implements IAttributeExtension {

	@Override
	public String getAttributeTypeName() {
		return PPUStringTable.FBD_IMPLEMENTATION_ATTR_TYPE;
	}
	...
	public List<AbstractAttribute> getAttributes() {
		List<Object> attrs = RCPContentProvider.getInstanceFromBundle(PPUStringTable.FBD_IMPL_ATTRIBUTE_SYMBOLIC_NAME ,PPUStringTable.FBD_ATTR_EXTENSION);
	...
	public void execute(ServiceContainer services, AbstractAttribute attribute) {
		...
		services.eventBroker.send(PPUEventTable.ADD_FBD_IMPL_ATTR, attribute);
	}
} 

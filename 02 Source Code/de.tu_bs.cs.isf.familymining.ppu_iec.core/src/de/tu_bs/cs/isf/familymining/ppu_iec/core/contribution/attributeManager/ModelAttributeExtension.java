...
public class ModelAttributeExtension implements IAttributeExtension {

	@Override
	public String getAttributeTypeName() {
		return PPUStringTable.PROJECT_CONTAINER_NAME;
	}

	@Override
	public List<AbstractAttribute> getAttributes() {
		List<Object> attrs = RCPContentProvider.getInstanceFromBundle(PPUStringTable.MODEL_ATTRIBUTE_SYMBOLIC_NAME,PPUStringTable.MODEL_ATTR_EXTENSION);
	...
	public Color getAttributeColor() {
		return ConfigurationManagerColor.MODEL_ATTR_COLOR;
	}
	
	@Override
	public Color getAttributeTypColor() {
		return ConfigurationManagerColor.MODEL_CONTAINER_COLOR;
	}
	@Override
	public Image getIcon(RCPImageService imageService) {
		return imageService.getImage(PPUStringTable.BUNDLE_NAME ,PPUFileTable.MODEL_ATTRIBUTE_16);
	}
	...
	public void execute(ServiceContainer services, AbstractAttribute attribute) {
		...
		services.eventBroker.send(PPUEventTable.ADD_MODEL_ATTR, attribute);
	}

...
public class LDImplAttributeExtension implements IAttributeExtension {

	@Override
	public String getAttributeTypeName() {
		return PPUStringTable.LD_IMPLEMENTATION_ATTR_TYPE;
	}
	...
	public List<AbstractAttribute> getAttributes() {
		List<Object> attrs = RCPContentProvider.getInstanceFromBundle(PPUStringTable.LD_IMPL_ATTRIBUTE_SYMBOLIC_NAME ,PPUStringTable.LD_ATTR_EXTENSION);
	...
	public void execute(ServiceContainer services, AbstractAttribute attribute) {
		...
		services.eventBroker.send(PPUEventTable.ADD_LD_IMPL_ATTR, attribute);
	}

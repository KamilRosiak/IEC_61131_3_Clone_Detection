 ...
 */
public class FBSR extends FBRawButton {

	private static final String[] INPUTPARAMETER = {"EN", "SET1", "RESET"};
	private static final String[] OUTPUTPARAMETER = {"Q1"};
	private static final String ID = "SR";
	
	/**
	 * creates an FBSR element from the FB language
	 * @param scale - to make the object bigger or smaller, default is 1
	 * @param colorValue 
	 */
	public FBSR(int scale, String Name, String[] inputExp, String[] outputExp, int colorValue) {
		super(ID, INPUTPARAMETER, OUTPUTPARAMETER, scale, Name, inputExp, outputExp, colorValue);
	}
	
	public FBSR(String Name, String[] inputExp, String[] outputExp, int colorValue) {

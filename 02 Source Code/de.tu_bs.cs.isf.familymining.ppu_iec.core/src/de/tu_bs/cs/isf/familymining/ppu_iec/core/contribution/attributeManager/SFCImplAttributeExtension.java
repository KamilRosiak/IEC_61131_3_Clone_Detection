...
public class SFCImplAttributeExtension implements IAttributeExtension {

	@Override
	public String getAttributeTypeName() {
		return PPUStringTable.SFC_IMPLEMENTATION_ATTR_TYPE;
	}
	...
	public List<AbstractAttribute> getAttributes() {
		List<Object> attrs = RCPContentProvider.getInstanceFromBundle(PPUStringTable.SFC_IMPL_ATTRIBUTE_SYMBOLIC_NAME ,PPUStringTable.SFC_ATTR_EXTENSION);
	...
	public void execute(ServiceContainer services, AbstractAttribute attribute) {
		...
		services.eventBroker.send(PPUEventTable.ADD_SFC_IMPL_ATTR, attribute);
	}

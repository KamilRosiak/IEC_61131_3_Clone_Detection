...
public class SFC_Step_Name_Attr extends AbstractSFCImplAttribute{
	/**
	 * 
	 */
	private static final long serialVersionUID = 5804049127623945449L;
	public static final String UNIT_NAME = "SFC Step Name Compare";
	public static final String UNIT_DESCRIPTION = "Compares the names of two given steps."; 
	
	public SFC_Step_Name_Attr() {

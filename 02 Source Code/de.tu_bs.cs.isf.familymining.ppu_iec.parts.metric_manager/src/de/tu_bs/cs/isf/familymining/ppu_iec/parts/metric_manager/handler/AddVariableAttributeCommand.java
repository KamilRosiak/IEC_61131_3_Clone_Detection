...
public class AddVariableAttributeCommand {
	...
	public void execute(ServiceContainer serviceContainer) { 
		if(_selection.getSelection() instanceof Tree) {
			new AttributeManager(serviceContainer, PPUStringTable.VARIABLE_ATTRIBUTE_SYMBOLIC_NAME, PPUStringTable.VARIABLE_ATTR_EXTENSION,(Tree)_selection.getSelection(), _eventBroker);
			_eventBroker.send(CompareEngineEventConsts.UPDATE_CONFIG, "");
		}
	}

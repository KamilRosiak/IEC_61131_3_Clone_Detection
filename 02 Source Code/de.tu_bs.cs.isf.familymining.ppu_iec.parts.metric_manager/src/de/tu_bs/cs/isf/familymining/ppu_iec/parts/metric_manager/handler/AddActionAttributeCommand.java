...
public class AddActionAttributeCommand {
	...
	public void execute(ServiceContainer serviceContainer) { 
		if(_selection.getSelection() instanceof Tree) {
			new AttributeManager(serviceContainer, PPUStringTable.ACTION_ATTRIBUTE_SYMBOLIC_NAME, PPUStringTable.ACTION_ATTR_EXTENSION,(Tree)_selection.getSelection(), _eventBroker);

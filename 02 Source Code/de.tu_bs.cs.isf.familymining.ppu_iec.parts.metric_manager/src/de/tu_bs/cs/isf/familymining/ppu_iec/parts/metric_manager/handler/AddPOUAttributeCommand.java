...
public class AddPOUAttributeCommand {
	...
	public void execute(ServiceContainer serviceContainer) { 
		if(_selection.getSelection() instanceof Tree) {
			new AttributeManager(serviceContainer, PPUStringTable.POU_ATTRIBUTE_SYMBOLIC_NAME, PPUStringTable.POU_ATTR_EXTENSION,(Tree)_selection.getSelection(), _eventBroker);

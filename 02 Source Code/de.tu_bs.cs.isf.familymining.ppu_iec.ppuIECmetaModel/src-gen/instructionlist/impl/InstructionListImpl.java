 ...
 * </p>
 * <ul>
 *   <li>{@link instructionlist.impl.InstructionListImpl#getName <em>Name</em>}</li>
 *   <li>{@link instructionlist.impl.InstructionListImpl#getNetwork <em>Network</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InstructionListImpl extends LanguageElementImpl implements InstructionList {
	/**
	...
	protected EClass eStaticClass() {
		return InstructionListPackage.Literals.INSTRUCTION_LIST;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InstructionListPackage.INSTRUCTION_LIST__NAME, oldName, name));
	}
	...
	public EList<Network> getNetwork() {
		if (network == null) {
			network = new EObjectContainmentEList<Network>(Network.class, this, InstructionListPackage.INSTRUCTION_LIST__NETWORK);
		}
		return network;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case InstructionListPackage.INSTRUCTION_LIST__NETWORK:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case InstructionListPackage.INSTRUCTION_LIST__NAME:
				return getName();
			case InstructionListPackage.INSTRUCTION_LIST__NETWORK:
				return getNetwork();
		}

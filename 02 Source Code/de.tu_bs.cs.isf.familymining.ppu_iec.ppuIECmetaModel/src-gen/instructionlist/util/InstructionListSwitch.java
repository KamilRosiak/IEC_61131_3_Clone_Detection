...
public class InstructionListSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case InstructionListPackage.INSTRUCTION_LIST: {
				InstructionList instructionList = (InstructionList)theEObject;
				T result = caseInstructionList(instructionList);
				if (result == null) result = caseLanguageElement(instructionList);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case InstructionListPackage.INSTRUCTION: {
				Instruction instruction = (Instruction)theEObject;
				T result = caseInstruction(instruction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case InstructionListPackage.OPERATOR: {
				Operator operator = (Operator)theEObject;
				T result = caseOperator(operator);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case InstructionListPackage.OPERAND: {
			...
			case InstructionListPackage.FUNCTION_CALL: {
				...
				if (result == null) result = casePOU(functionCall);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case InstructionListPackage.NETWORK: {
				Network network = (Network)theEObject;
				T result = caseNetwork(network);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case InstructionListPackage.JUMP: {

 ...
 * <!-- end-user-doc -->
 * @see de.tu_bs.cs.isf.familymining.ppu_iec.ppuIECmetaModel.diagram.DiagramPackage#getDiagramType()
 * @model
 * @generated
 */
public enum DiagramType implements Enumerator {
	 ...
	 * @ordered
	 */
	LADDER_DIAGRAM(0, "LadderDiagram", "LadderDiagram"),
	 ...
	 * @ordered
	 */
	FUNCTION_BLOCK_DIAGRAM(0, "FunctionBlockDiagram", "FunctionBlockDiagram");
	 ...
	 * @ordered
	 */
	public static final int LADDER_DIAGRAM_VALUE = 0;
	 ...
	 * @ordered
	 */
	public static final int FUNCTION_BLOCK_DIAGRAM_VALUE = 0;

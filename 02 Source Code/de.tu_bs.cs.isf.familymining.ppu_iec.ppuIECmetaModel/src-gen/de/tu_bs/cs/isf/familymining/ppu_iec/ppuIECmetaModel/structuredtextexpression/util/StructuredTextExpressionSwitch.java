 ...
 * @generated
 */
public class StructuredTextExpressionSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public StructuredTextExpressionSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case StructuredTextExpressionPackage.EXPRESSION: {
			...
			case StructuredTextExpressionPackage.BINARY_EXPRESSION: {
				BinaryExpression binaryExpression = (BinaryExpression)theEObject;
				T result = caseBinaryExpression(binaryExpression);
				if (result == null) result = caseExpression(binaryExpression);
				if (result == null) result = caseIdentifier(binaryExpression);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StructuredTextExpressionPackage.UNARY_EXPRESSION: {
				UnaryExpression unaryExpression = (UnaryExpression)theEObject;
				T result = caseUnaryExpression(unaryExpression);
				if (result == null) result = caseExpression(unaryExpression);
				if (result == null) result = caseIdentifier(unaryExpression);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StructuredTextExpressionPackage.LITERAL: {
			...
			case StructuredTextExpressionPackage.VARIABLE_EXPRESSION: {
				...
				if (result == null) result = caseIdentifier(variableExpression);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StructuredTextExpressionPackage.FUNCTION_CALL_EXPRESSION: {
				...
				if (result == null) result = caseIdentifier(functionCallExpression);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StructuredTextExpressionPackage.PARAMETER: {
				Parameter parameter = (Parameter)theEObject;
				T result = caseParameter(parameter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StructuredTextExpressionPackage.SUBRANGE: {
				Subrange subrange = (Subrange)theEObject;
				T result = caseSubrange(subrange);
				if (result == null) result = caseExpression(subrange);
				if (result == null) result = caseIdentifier(subrange);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StructuredTextExpressionPackage.IDENTIFIER: {
...
} //StructuredTextExpressionSwitch

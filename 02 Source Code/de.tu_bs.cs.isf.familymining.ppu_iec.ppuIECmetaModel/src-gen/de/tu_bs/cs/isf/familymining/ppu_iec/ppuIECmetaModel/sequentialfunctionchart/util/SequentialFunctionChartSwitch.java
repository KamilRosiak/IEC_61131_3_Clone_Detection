 ...
 * @generated
 */
public class SequentialFunctionChartSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public SequentialFunctionChartSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SequentialFunctionChartPackage.STEP: {
				Step step = (Step)theEObject;
				T result = caseStep(step);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SequentialFunctionChartPackage.SEQUENTIAL_FUNCTION_CHART: {
				...
				if (result == null) result = caseLanguageElement(sequentialFunctionChart);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SequentialFunctionChartPackage.TRANSITION: {
				Transition transition = (Transition)theEObject;
				T result = caseTransition(transition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SequentialFunctionChartPackage.ABSTRACT_ACTION: {
				AbstractAction abstractAction = (AbstractAction)theEObject;
				T result = caseAbstractAction(abstractAction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SequentialFunctionChartPackage.SIMPLE_ACTION: {
				SimpleAction simpleAction = (SimpleAction)theEObject;
				T result = caseSimpleAction(simpleAction);
				if (result == null) result = caseAbstractAction(simpleAction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SequentialFunctionChartPackage.COMPLEX_ACTION: {
				ComplexAction complexAction = (ComplexAction)theEObject;
				T result = caseComplexAction(complexAction);
				if (result == null) result = caseAbstractAction(complexAction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}

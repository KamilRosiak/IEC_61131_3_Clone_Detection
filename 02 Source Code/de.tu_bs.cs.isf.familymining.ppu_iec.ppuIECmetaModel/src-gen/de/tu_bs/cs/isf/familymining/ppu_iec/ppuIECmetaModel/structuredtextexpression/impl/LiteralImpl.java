 ...
 * </p>
 * <ul>
 *   <li>{@link de.tu_bs.cs.isf.familymining.ppu_iec.ppuIECmetaModel.structuredtextexpression.impl.LiteralImpl#getSymbol <em>Symbol</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LiteralImpl extends ExpressionImpl implements Literal {
	...
	protected EClass eStaticClass() {
		return StructuredTextExpressionPackage.Literals.LITERAL;
	}
	...
	public void setSymbol(String newSymbol) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StructuredTextExpressionPackage.LITERAL__SYMBOL, oldSymbol, symbol));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StructuredTextExpressionPackage.LITERAL__SYMBOL:
				return getSymbol();
		}
